...
- `references/sahibinden-cloudflare-atlatma.md` — Cloudflare korumali siteleri (sahibinden.com örnegi) spike'lama denemesi, 4 farkli yontem, INVALIDATED verdict. Yeni bir scraper spike'ina baslamadan once buradaki basarisiz yaklasimlari referans al.
